...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
<<<<<<< HEAD
                <table id="empl_tbl" class="table table-striped table-bordered"  >
=======
                <table id="empl_tbl" class="table table-striped table-bordered" >
...
<tbody>
    ...
    <tr>
        ...
        <td>{{ c_pm_generic::gf_build_sex_____($row->sex_____) }}</td>
        <td>{{ c_pm_generic::gf_build_cvilstat($row->cvilstat) }}</td>
        <td>{{ $row->mpl_desc }}</td> <!-- Employment Status -->
        <td>{{ c_pm_generic::gf_build_position($row->pos_code) }}</td> <!-- Employee Position -->
        <td>{{ $row->pyg_desc }}</td> <!-- Payroll Group -->
        <td>{{ (strcmp($row->rate_typ,'D')==0) ? 'Daily' : 'Monthly' }}</td>
        <td>{{ $row->dte_hire }}</td>
        <td>{{ $row->dte_eoc_ }}</td>
        <td>{{ $row->dte_rsgn }}</td>
        ...
        <td>{{ $row->sss_numb }}</td>
        <td>{{ $row->pag_ibig }}</td>
        <td>{{ $row->div_desc }}</td> <!-- Division -->
        <td>{{ $row->dep_desc }}</td> <!-- Department -->
        <td>{{ $row->sec_desc }}</td> <!-- Section -->
        <td>{{ $row->wrk_desc }}</td> <!-- Work Area -->
        <td>{{ $row->ot__desc }}</td> <!-- OT Group -->
        <td>{{ (strcmp($row->alw_ot__,'T')==0) ? 'Yes' : 'No' }}</td>
        <td>{{ (strcmp($row->alw_nsd_,'T')==0) ? 'Yes' : 'No' }}</td>
        <td>
            <a href="{{ action('EmployeeController@edit', $row->empl_cde) }}">Edit</a>
